VERILATOR ?= verilator
VERILATOR_FLAGS ?= -Wall -Wno-PINMISSING -sv --timing
BUILD_DIR ?= obj_dir
...
.PHONY: lint test tb-cond tb-arm-decode tb-thumb-decode tb-shifter tb-alu tb-regfile tb-core-smoke tb-core-branch tb-core-cycle-timing tb-core-bus-cycle-timing tb-core-mem-cycle-timing tb-core-halfword-cycle-timing tb-core-swap-cycle-timing tb-core-swap-wait-cycle-timing tb-core-thumb-cycle-timing tb-core-thumb-ldr-pc-cycle-timing tb-core-thumb-condbranch-cycle-timing tb-core-thumb-ls-reg-cycle-timing tb-core-thumb-ls-sp-cycle-timing tb-core-thumb-add-addr-cycle-timing tb-core-thumb-sp-adjust-cycle-timing tb-core-thumb-ls-imm-wait-cycle-timing tb-core-thumb-block-wait-cycle-timing tb-core-thumb-stack-cycle-timing tb-core-exception-cycle-timing tb-core-block-cycle-timing tb-core-block-wait-cycle-timing tb-core-prefetch-abort-cycle-timing tb-core-interrupt-cycle-timing tb-core-data-abort-cycle-timing tb-core-swap-abort-cycle-timing tb-core-block-abort-cycle-timing tb-core-thumb-data-abort-cycle-timing tb-core-thumb-data-abort-store-cycle-timing tb-core-thumb-interwork-cycle-timing tb-core-thumb-swi-cycle-timing tb-core-thumb-undefined-cycle-timing tb-core-thumb-unsupported-cycle-timing tb-core-thumb-interrupt-cycle-timing tb-core-thumb-prefetch-abort-cycle-timing tb-core-unsupported-cycle-timing tb-core-coprocessor-undefined-cycle-timing tb-core-coprocessor-abort-cycle-timing tb-core-coprocessor-wait-cycle-timing tb-core-multiply-edge-cycle-timing tb-core-cosim-smoke tb-core-cosim-thumb-interrupt-smoke tb-core-cosim-thumb-fiq-smoke tb-core-cosim-thumb-prefetch-abort-smoke tb-core-cosim-thumb-data-abort-smoke tb-core-cosim-thumb-data-abort-store-smoke tb-core-cosim-thumb-alu-smoke tb-core-cosim-thumb-hireg-smoke tb-core-cosim-thumb-shift-smoke tb-core-cosim-thumb-addsub-smoke tb-core-cosim-thumb-stack-smoke tb-core-cosim-thumb-ls-reg-smoke tb-core-cosim-thumb-ls-sp-smoke tb-core-cosim-thumb-sp-adjust-smoke tb-core-cosim-thumb-add-addr-smoke tb-core-thumb-interwork tb-core-thumb-shift tb-core-thumb-addsub tb-core-thumb-condbranch tb-core-thumb-hireg tb-core-thumb-alu tb-core-thumb-ldr-pc tb-core-thumb-ls-imm tb-core-thumb-ls-imm-wait tb-core-thumb-ls-reg tb-core-thumb-ls-sp tb-core-thumb-add-addr tb-core-thumb-sp-adjust tb-core-thumb-block tb-core-thumb-block-wait tb-core-thumb-stack tb-core-thumb-swi tb-core-thumb-bl tb-core-thumb-undefined tb-core-thumb-unsupported tb-core-thumb-data-abort tb-core-thumb-data-abort-store tb-core-mem tb-core-mem-wait tb-core-mem-ttrans tb-core-mem-regoffset tb-core-mem-pc tb-core-mem-pc-store tb-core-mem-pc-byte tb-core-mem-pc-down tb-core-mem-unaligned tb-core-multiply tb-core-halfword tb-core-halfword-modes tb-core-psr tb-core-coprocessor tb-core-coprocessor-wait tb-core-coprocessor-abort tb-core-coprocessor-cycle-timing tb-core-cosim-arm-coprocessor-smoke tb-core-swap tb-core-swap-wait tb-core-block tb-core-block-wait tb-core-block-empty tb-core-block-pc tb-core-block-pc-restore tb-core-block-user tb-core-exception tb-core-undefined tb-core-unsupported tb-core-interrupt tb-core-prefetch-abort tb-core-data-abort tb-core-data-abort-store tb-core-swap-abort tb-core-block-abort tb-core-block-abort-wait tb-core-exception-return clean
...
.PHONY: tb-core-cosim-arm-psr-smoke
.PHONY: tb-core-cosim-arm-interrupt-smoke
.PHONY: tb-core-cosim-arm-coprocessor-smoke
.PHONY: tb-core-cosim-arm-unsupported-smoke

lint:
	$(VERILATOR) --lint-only $(VERILATOR_FLAGS) -f rtl/files.f

test: lint tb-cond tb-arm-decode tb-thumb-decode tb-shifter tb-alu tb-regfile tb-core-smoke tb-core-branch tb-core-cycle-timing tb-core-bus-cycle-timing tb-core-mem-cycle-timing tb-core-halfword-cycle-timing tb-core-swap-cycle-timing tb-core-swap-wait-cycle-timing tb-core-thumb-cycle-timing tb-core-thumb-ldr-pc-cycle-timing tb-core-thumb-condbranch-cycle-timing tb-core-thumb-ls-reg-cycle-timing tb-core-thumb-ls-sp-cycle-timing tb-core-thumb-add-addr-cycle-timing tb-core-thumb-sp-adjust-cycle-timing tb-core-thumb-ls-imm-wait-cycle-timing tb-core-thumb-block-wait-cycle-timing tb-core-thumb-stack-cycle-timing tb-core-exception-cycle-timing tb-core-block-cycle-timing tb-core-block-wait-cycle-timing tb-core-prefetch-abort-cycle-timing tb-core-interrupt-cycle-timing tb-core-data-abort-cycle-timing tb-core-swap-abort-cycle-timing tb-core-block-abort-cycle-timing tb-core-thumb-data-abort-cycle-timing tb-core-thumb-data-abort-store-cycle-timing tb-core-thumb-interwork-cycle-timing tb-core-thumb-swi-cycle-timing tb-core-thumb-undefined-cycle-timing tb-core-thumb-unsupported-cycle-timing tb-core-thumb-interrupt-cycle-timing tb-core-thumb-prefetch-abort-cycle-timing tb-core-multiply-edge-cycle-timing tb-core-thumb-interwork tb-core-thumb-shift tb-core-thumb-addsub tb-core-thumb-condbranch tb-core-thumb-hireg tb-core-thumb-alu tb-core-thumb-ldr-pc tb-core-thumb-ls-imm tb-core-thumb-ls-imm-wait tb-core-thumb-ls-reg tb-core-thumb-ls-sp tb-core-thumb-add-addr tb-core-thumb-sp-adjust tb-core-thumb-block tb-core-thumb-block-wait tb-core-thumb-stack tb-core-thumb-swi tb-core-thumb-bl tb-core-thumb-undefined tb-core-thumb-unsupported tb-core-thumb-data-abort tb-core-thumb-data-abort-store tb-core-mem tb-core-mem-wait tb-core-mem-ttrans tb-core-mem-regoffset tb-core-mem-pc tb-core-mem-pc-store tb-core-mem-pc-byte tb-core-mem-pc-down tb-core-mem-unaligned tb-core-multiply tb-core-halfword tb-core-halfword-modes tb-core-psr tb-core-coprocessor tb-core-coprocessor-wait tb-core-coprocessor-abort tb-core-coprocessor-cycle-timing tb-core-swap tb-core-swap-wait tb-core-block tb-core-block-wait tb-core-block-empty tb-core-block-pc tb-core-block-pc-restore tb-core-block-user tb-core-exception tb-core-undefined tb-core-interrupt tb-core-prefetch-abort tb-core-data-abort tb-core-data-abort-store tb-core-swap-abort tb-core-block-abort tb-core-block-abort-wait tb-core-exception-return
...
tb-core-halfword-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_halfword_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_halfword_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_halfword_cycle_timing

tb-core-swap-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_swap_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_swap_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_swap_cycle_timing

tb-core-swap-wait-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_swap_wait_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_swap_wait_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_swap_wait_cycle_timing
...
tb-core-thumb-ldr-pc-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_ldr_pc_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_ldr_pc_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_ldr_pc_cycle_timing

tb-core-thumb-condbranch-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_condbranch_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_condbranch_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_condbranch_cycle_timing

tb-core-thumb-ls-reg-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_ls_reg_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_ls_reg_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_ls_reg_cycle_timing

tb-core-thumb-ls-sp-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_ls_sp_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_ls_sp_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_ls_sp_cycle_timing

tb-core-thumb-add-addr-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_add_addr_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_add_addr_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_add_addr_cycle_timing

tb-core-thumb-sp-adjust-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_sp_adjust_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_sp_adjust_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_sp_adjust_cycle_timing

tb-core-thumb-ls-imm-wait-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_ls_imm_wait_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_ls_imm_wait_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_ls_imm_wait_cycle_timing

tb-core-thumb-block-wait-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_block_wait_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_block_wait_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_block_wait_cycle_timing

tb-core-thumb-stack-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_thumb_stack_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_thumb_stack_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_thumb_stack_cycle_timing
...
tb-core-block-wait-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_block_wait_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_block_wait_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_block_wait_cycle_timing
...
tb-core-unsupported-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_unsupported_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_unsupported_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_unsupported_cycle_timing

tb-core-coprocessor-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_cycle_timing

tb-core-coprocessor-undefined-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_undefined_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_undefined_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_undefined_cycle_timing

tb-core-coprocessor-abort-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_abort_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_abort_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_abort_cycle_timing

tb-core-coprocessor-wait-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_wait_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_wait_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_wait_cycle_timing

tb-core-multiply-edge-cycle-timing:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_multiply_edge_cycle_timing $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_multiply_edge_cycle_timing.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_multiply_edge_cycle_timing

tb-core-cycle-timing-smokes: tb-core-cycle-timing tb-core-bus-cycle-timing tb-core-mem-cycle-timing tb-core-halfword-cycle-timing tb-core-swap-cycle-timing tb-core-swap-wait-cycle-timing tb-core-thumb-cycle-timing tb-core-thumb-ldr-pc-cycle-timing tb-core-thumb-condbranch-cycle-timing tb-core-thumb-ls-reg-cycle-timing tb-core-thumb-ls-sp-cycle-timing tb-core-thumb-add-addr-cycle-timing tb-core-thumb-sp-adjust-cycle-timing tb-core-thumb-ls-imm-wait-cycle-timing tb-core-thumb-block-wait-cycle-timing tb-core-thumb-stack-cycle-timing tb-core-exception-cycle-timing tb-core-block-cycle-timing tb-core-block-wait-cycle-timing tb-core-prefetch-abort-cycle-timing tb-core-interrupt-cycle-timing tb-core-data-abort-cycle-timing tb-core-swap-abort-cycle-timing tb-core-block-abort-cycle-timing tb-core-thumb-data-abort-cycle-timing tb-core-thumb-data-abort-store-cycle-timing tb-core-thumb-interwork-cycle-timing tb-core-thumb-bl-cycle-timing tb-core-thumb-swi-cycle-timing tb-core-thumb-undefined-cycle-timing tb-core-thumb-unsupported-cycle-timing tb-core-thumb-interrupt-cycle-timing tb-core-thumb-prefetch-abort-cycle-timing tb-core-unsupported-cycle-timing tb-core-coprocessor-cycle-timing tb-core-coprocessor-undefined-cycle-timing tb-core-coprocessor-abort-cycle-timing tb-core-coprocessor-wait-cycle-timing tb-core-multiply-edge-cycle-timing
...
tb-core-cosim-thumb-fiq-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_thumb_fiq_smoke.memh +trace=/tmp/arm7tdmi_cosim_thumb_fiq_smoke_rtl.jsonl +retired_limit=12 +max_cycles=260 +fiq_raise_cycle=9 +fiq_clear_on_reg_addr=14
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_thumb_fiq_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_thumb_fiq_smoke_ref.jsonl
...
tb-core-cosim-thumb-data-abort-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_thumb_data_abort_smoke.memh +trace=/tmp/arm7tdmi_cosim_thumb_data_abort_smoke_rtl.jsonl +retired_limit=10 +max_cycles=240 +abort_on_fetch_addr=44 +abort_on_debug_pc=22
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_thumb_data_abort_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_thumb_data_abort_smoke_ref.jsonl

tb-core-cosim-thumb-data-abort-store-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_thumb_data_abort_store_smoke.memh +trace=/tmp/arm7tdmi_cosim_thumb_data_abort_store_smoke_rtl.jsonl +retired_limit=11 +max_cycles=260 +abort_on_write_addr=44 +abort_on_debug_pc=24
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_thumb_data_abort_store_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_thumb_data_abort_store_smoke_ref.jsonl

tb-core-cosim-thumb-exception-smokes: tb-core-cosim-thumb-interrupt-smoke tb-core-cosim-thumb-fiq-smoke tb-core-cosim-thumb-prefetch-abort-smoke tb-core-cosim-thumb-data-abort-smoke tb-core-cosim-thumb-data-abort-store-smoke tb-core-cosim-thumb-swi-smoke tb-core-cosim-thumb-undefined-smoke tb-core-cosim-thumb-unsupported-smoke
...
tb-core-cosim-thumb-smokes: tb-core-cosim-thumb-smoke tb-core-cosim-thumb-ls-smoke tb-core-cosim-thumb-bl-smoke tb-core-cosim-thumb-ldr-pc-smoke tb-core-cosim-thumb-condbranch-smoke tb-core-cosim-thumb-alu-smoke tb-core-cosim-thumb-hireg-smoke tb-core-cosim-thumb-shift-smoke tb-core-cosim-thumb-addsub-smoke tb-core-cosim-thumb-stack-smoke tb-core-cosim-thumb-ls-reg-smoke tb-core-cosim-thumb-ls-sp-smoke tb-core-cosim-thumb-sp-adjust-smoke tb-core-cosim-thumb-add-addr-smoke tb-core-cosim-thumb-exception-smokes
...
tb-core-cosim-arm-unsupported-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_arm_unsupported_smoke.memh +trace=/tmp/arm7tdmi_cosim_arm_unsupported_smoke_rtl.jsonl +retired_limit=5 +max_cycles=160 +allow_unsupported
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_arm_unsupported_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_arm_unsupported_smoke_ref.jsonl
...
tb-core-cosim-arm-psr-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_arm_psr_smoke.memh +trace=/tmp/arm7tdmi_cosim_arm_psr_smoke_rtl.jsonl +retired_limit=10 +max_cycles=220
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_arm_psr_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_arm_psr_smoke_ref.jsonl

tb-core-cosim-arm-interrupt-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_arm_interrupt_smoke.memh +trace=/tmp/arm7tdmi_cosim_arm_interrupt_smoke_rtl.jsonl +retired_limit=5 +max_cycles=220 +irq_raise_cycle=1 +irq_clear_on_reg_addr=14 +irq_clear_on_reg_data=0000000c
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_arm_interrupt_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_arm_interrupt_smoke_ref.jsonl

tb-core-cosim-arm-coprocessor-smoke:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_cosim_trace $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_cosim_trace.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_cosim_trace +memh=sim/model/arm7tdmi_cosim_arm_coprocessor_smoke.memh +trace=/tmp/arm7tdmi_cosim_arm_coprocessor_smoke_rtl.jsonl +retired_limit=10 +max_cycles=260 +coproc_dummy
	python3 scripts/cosim/compare_arm7tdmi_traces.py --rtl /tmp/arm7tdmi_cosim_arm_coprocessor_smoke_rtl.jsonl --ref sim/model/arm7tdmi_cosim_arm_coprocessor_smoke_ref.jsonl
...
tb-core-cosim-arm-smokes: tb-core-cosim-smoke tb-core-cosim-arm-swi-smoke tb-core-cosim-arm-undefined-smoke tb-core-cosim-arm-unsupported-smoke tb-core-cosim-arm-branch-smoke tb-core-cosim-arm-mem-smoke tb-core-cosim-arm-multiply-smoke tb-core-cosim-arm-psr-smoke tb-core-cosim-arm-interrupt-smoke tb-core-cosim-arm-coprocessor-smoke tb-core-cosim-arm-halfword-smoke tb-core-cosim-arm-swap-smoke tb-core-cosim-arm-block-smoke tb-core-cosim-arm-block-empty-smoke tb-core-cosim-arm-block-user-smoke tb-core-cosim-arm-block-pc-smoke tb-core-cosim-arm-block-pc-restore-smoke
...
cosim-mame-cm2005-thumb-fiq-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_thumb_fiq_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000
...
cosim-mame-cm2005-thumb-data-abort-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_thumb_data_abort_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000

cosim-mame-cm2005-thumb-data-abort-store-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_thumb_data_abort_store_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000
...
cosim-mame-cm2005-arm-multiply-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_arm_multiply_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000

cosim-mame-cm2005-arm-psr-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_arm_psr_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000

cosim-mame-cm2005-arm-interrupt-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_arm_interrupt_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000

cosim-mame-cm2005-arm-coprocessor-smoke-rom:
	python3 scripts/cosim/prepare_mame_rom_set.py --memh sim/model/arm7tdmi_cosim_arm_coprocessor_smoke.memh --set-name cm2005 --rom-name a29800uv.11b --rom-size 0x100000 --output-root /tmp/arm7tdmi_mame_roms --placeholder-rom a29800uv.12b:0x100000 --placeholder-rom gal16v8.10a:0x40000 --placeholder-rom gal16v8.10b:0x40000
...
tb-core-coprocessor:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor

tb-core-coprocessor-wait:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_wait $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_wait.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_wait

tb-core-coprocessor-abort:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_coprocessor_abort $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_coprocessor_abort.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_coprocessor_abort
...
tb-core-unsupported:
	$(VERILATOR) --binary $(VERILATOR_FLAGS) --top-module tb_arm7tdmi_core_unsupported $(RTL_FILES) sim/tb/sv/tb_arm7tdmi_core_unsupported.sv
	./$(BUILD_DIR)/Vtb_arm7tdmi_core_unsupported
