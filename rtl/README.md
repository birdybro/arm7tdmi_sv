...
- Full block transfer modes, fuller PSR transfer forms, and remaining load/store edge cases.
- Remaining exceptions, aborts, IRQ/FIQ entry, and return-from-exception paths.
