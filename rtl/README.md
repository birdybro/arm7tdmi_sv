...
- ARM block data transfer foundation: increment-after and increment-before `LDM`/`STM`, with optional writeback when `Rn` is not in the register list, and without PC in the register list.
