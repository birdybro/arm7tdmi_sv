...
(
  ...
  always_comb begin
    ...
    decoded_o = '{
      ...
      hword_immediate_offset: instr_i[22],
    ...
    unique casez (instr_i[27:25])
      3'b000, 3'b001: begin
        if (is_bx) begin
          ...
          decoded_o.supported = ((instr_i[6:5] == 2'b01) || instr_i[20]) &&
                                (instr_i[19:16] != 4'd15) && (instr_i[15:12] != 4'd15) &&
                                (instr_i[22] || (instr_i[11:8] == 4'h0)) &&
                                (!instr_i[21] || (instr_i[19:16] != instr_i[15:12]));
      ...
      3'b010, 3'b011: begin
        ...
        decoded_o.supported = (!instr_i[25] || !instr_i[4]) &&
                              (!instr_i[21] || (instr_i[19:16] != instr_i[15:12])) &&
                              ((instr_i[19:16] != 4'd15) || (instr_i[24] && !instr_i[21])) &&
                              ((instr_i[15:12] != 4'd15) ||
                               (instr_i[20] && !instr_i[22] && instr_i[24] && !instr_i[21]));
      end
