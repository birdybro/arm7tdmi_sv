...
;
  ...
  always_comb begin
    unique case (bus_addr)
      ...
      32'h0000_001C: bus_rdata = 32'hE0A7_6190; // UMLAL r6, r7, r0, r1
      32'h0000_0020: bus_rdata = 32'hE3E0_8000; // MVN r8, #0
      32'h0000_0024: bus_rdata = 32'hE3A0_9002; // MOV r9, #2
      32'h0000_0028: bus_rdata = 32'hE0CB_A998; // SMULL r10, r11, r8, r9
      32'h0000_002C: bus_rdata = 32'hE0EB_A998; // SMLAL r10, r11, r8, r9
  ...
  initial begin
    ...
    for (int cycle = 0; cycle < 100; cycle++) begin
      ...
      if (debug_reg_we && debug_reg_waddr == 4'd10 && debug_reg_wdata == 32'hFFFF_FFFC) begin
        smlal_lo_seen++;
      end
    ...
    if (r0_seen != 1 || r1_seen != 1 || r2_seen != 1 || r3_seen != 1 ||
        r4_seen != 1 || r5_seen != 1 || r6_seen != 1 || r7_seen != 2 ||
        r8_seen != 1 || r9_seen != 1 || r10_seen != 1 || r11_seen != 2 ||
        umlal_lo_seen != 1 || umlal_hi_seen != 2 ||
        smlal_lo_seen != 1 || smlal_hi_seen != 2) begin
      $fatal(1, "expected multiply program writes, saw r0=%0d r1=%0d r2=%0d r3=%0d r4=%0d r5=%0d r6=%0d r7=%0d r8=%0d r9=%0d r10=%0d r11=%0d umlal_lo=%0d umlal_hi=%0d smlal_lo=%0d smlal_hi=%0d",
             r0_seen, r1_seen, r2_seen, r3_seen, r4_seen, r5_seen,
             r6_seen, r7_seen, r8_seen, r9_seen, r10_seen, r11_seen,
             umlal_lo_seen, umlal_hi_seen, smlal_lo_seen, smlal_hi_seen);
    end
